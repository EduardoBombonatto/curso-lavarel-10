...
@section('content')
    <form class="form" method="POST" action="{{ route('cadastrar.venda') }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" disabled value="{{ $findNumeracao }}" class="form-control @error('numero_da_venda') is-invalid @enderror"
        ...
        <div class="mb-3">
            ...
            <select class="form-select" name="produto_id">
                <option selected>Selectionar produto</option>
        ...
        <div class="mb-3">
            ...
            <select class="form-select" name="cliente_id">
                <option selected>Selectionar cliente</option>
