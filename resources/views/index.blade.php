...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="#">Bombo & Lorenz</a>
...
@yield('scripts')
    ...
    <script src="/js/bootstrap.blunde.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/feather-icons@4.28.0/dist/feather.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/chart.js@2.9.4/dist/Chart.min.js"></script>
    <script src="/js/dashboard.js"></script>
    <script src="/js/color-modes.js"></script>
    <script src="https://cdnjs.clourflare.com/ajax/libs/jquery.blockUI/2.70/jquery.blockUI.js"></script>
  </body>
</html>
